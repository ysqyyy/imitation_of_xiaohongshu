  ...
  >
    <div class="video-player-container">
      ...
      <div class="video-info" @click.stop>
        <div class="video-content">
          ...
          <div class="video-author">
            <img :src="currentPost?.author.img" :alt="currentPost?.author.name" class="author-avatar" />
      ...
      <div class="video-counter">
        {{ props.currentIndex + 1 }} / {{ props.posts.length }}
      </div>
    </div>
  </div>
</template>
